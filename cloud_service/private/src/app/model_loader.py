...
def load_ml_model():
    ...
    # Resolviendo la ruta hacia la nueva carpeta Entrenamineto_LSTM
    default_model_path = os.path.join(os.path.dirname(__file__), 'Entrenamineto_LSTM', 'embedding_network_mini.h5')
