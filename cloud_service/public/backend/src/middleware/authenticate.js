...
function loadPublicKey() {
  const path = process.env.JWT_PUBLIC_KEY_PATH || process.env.JWT_PRIVATE_KEY_PATH;
  if (!path) throw new Error('JWT_PUBLIC_KEY_PATH or JWT_PRIVATE_KEY_PATH must be set');
